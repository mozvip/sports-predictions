...
public interface ActualResultDAO {
	  ...
	  void insert(@Bind("match_id") int match_id, @Bind("home_score") int home_score, @Bind("away_score") int away_score, @Bind("home_team_id") String home_team_id, @Bind("away_team_id") String away_team_id, @Bind("home_winner") boolean home_winner);
