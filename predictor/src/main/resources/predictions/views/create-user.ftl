  ...
  <body>
	...
	<script>
		...
		function checkAvailability( email ) {
			$.get( "/user/availability?email=" + email, function( data ) {
  				alert(data);
			});
		}
    ...
    <div class="container">
		...
		<form role="form" action="/user/create" method="POST">
		  ...
		  <div class="form-group">
		    ...
		    <input type="email" class="form-control" required id="email" placeholder="Enter email" onchange="checkAvailability(this.value)">
		  </div>
		  <div class="form-group">
